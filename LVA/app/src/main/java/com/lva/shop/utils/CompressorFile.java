...
public class CompressorFile {
    ...
    public CompressorFile(Context context) {
        destinationDirectoryPath = context.getCacheDir().getPath() + File.separator + "images";
    }

    public CompressorFile setMaxWidth(int maxWidth) {
        this.maxWidth = maxWidth;
        return this;
    }

    public CompressorFile setMaxHeight(int maxHeight) {
        this.maxHeight = maxHeight;
        return this;
    }

    public CompressorFile setCompressFormat(Bitmap.CompressFormat compressFormat) {
        this.compressFormat = compressFormat;
        return this;
    }

    public CompressorFile setQuality(int quality) {
        this.quality = quality;
        return this;
    }

    public CompressorFile setDestinationDirectoryPath(String destinationDirectoryPath) {
